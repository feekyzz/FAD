...
if __name__ == '__main__':
    postfix = 'jpg'
    img_path = r'C:\Studyproject\TVCG\YOLOv8.2\val_imgs'  #测试图像
    predict_path = r'C:\Studyproject\TVCG\YOLOv8.2\Trick\compare\yologt'
    label_path = r"C:\Studyproject\TVCG\YOLOv8.2\runs\detect\Bad89.3\2_trick"
    save_path = 'compare_Best89.3'
    classes = ['Car', 'Cyclist', 'Pedestrian']
    detect_color, missing_color, error_color  = (0, 255, 0), (0, 0, 255), (255, 0, 0)# (red, green, blue)
    iou_threshold = 0.5
