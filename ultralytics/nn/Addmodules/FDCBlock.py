...
#
#
# class FDCBlock(ModulatedDeformConv2d):
#
#     _version = 2
#
...
#     def forward(self, x):
#
#         print(f"FDCBlock input shape: {x.shape}")
#
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        ...
        self.cv1 = AdaptiveDilatedConv(c1, c_, k[0], 1)
        self.cv2 = AdaptiveDilatedConv(c_,c2,k[1], stride=1, groups=g)
