...
class CCA_2(nn.Module):
    def __init__(self, inter_dim=512):
        super(CCA_2, self).__init__()
...
class CCA_3(nn.Module):
    def __init__(self, inter_dim=512):
        super(CCA_3, self).__init__()
...
class CCA_4(nn.Module):
    def __init__(self, inter_dim=512):
        super(CCA_4, self).__init__()
...
class BlockBody(nn.Module):
    def __init__(self, channels=[64, 128, 256, 512]):
        ...
        self.CCA_scalezero1 = CCA_2(inter_dim=channels[0])
        self.CCA_scaleone1 = CCA_2(inter_dim=channels[1])
        ...
        self.CCA_scalezero2 = CCA_3(inter_dim=channels[0])
        self.CCA_scaleone2 = CCA_3(inter_dim=channels[1])
        self.CCA_scaletwo2 = CCA_3(inter_dim=channels[2])
        ...
        self.CCA_scalezero3 = CCA_4(inter_dim=channels[0])
        self.CCA_scaleone3 = CCA_4(inter_dim=channels[1])
        self.CCA_scaletwo3 = CCA_4(inter_dim=channels[2])
        self.CCA_scalethree3 = CCA_4(inter_dim=channels[3])
    ...
    def forward(self, x):
        ...
        scalezero = self.CCA_scalezero1(x0, self.upsample_scaleone1_2(x1))
        scaleone = self.CCA_scaleone1(self.downsample_scalezero1_2(x0), x1)

        x0 = self.blocks_scalezero2(scalezero)
        x1 = self.blocks_scaleone2(scaleone)

        scalezero = self.CCA_scalezero2(x0, self.upsample_scaleone2_2(x1), self.upsample_scaletwo2_4(x2))
        scaleone = self.CCA_scaleone2(self.downsample_scalezero2_2(x0), x1, self.upsample_scaletwo2_2(x2))
        scaletwo = self.CCA_scaletwo2(self.downsample_scalezero2_4(x0), self.downsample_scaleone2_2(x1), x2)

        x0 = self.blocks_scalezero3(scalezero)
        x1 = self.blocks_scaleone3(scaleone)
        x2 = self.blocks_scaletwo3(scaletwo)

        scalezero = self.CCA_scalezero3(x0, self.upsample_scaleone3_2(x1), self.upsample_scaletwo3_4(x2),
                                         self.upsample_scalethree3_8(x3))
        scaleone = self.CCA_scaleone3(self.downsample_scalezero3_2(x0), x1, self.upsample_scaletwo3_2(x2),
                                       self.upsample_scalethree3_4(x3))
        scaletwo = self.CCA_scaletwo3(self.downsample_scalezero3_4(x0), self.downsample_scaleone3_2(x1), x2,
                                       self.upsample_scalethree3_2(x3))
        scalethree = self.CCA_scalethree3(self.downsample_scalezero3_8(x0), self.downsample_scaleone3_4(x1),
...
class NASF(nn.Module):
    def __init__(self,
                 in_channels=[256, 512, 1024, 2048],
                 out_channels=128):
        super(NASF, self).__init__()
