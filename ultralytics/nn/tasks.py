...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect, Detect_NASF)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 nn.ConvTranspose2d,  DWConvTranspose2d, C3x, RepC3,  RepConv,
                nn.Conv2d,
                  Blocks, ConvNormLayer,SPPELAN):
            c1, c2 = ch[f], args[0]
        ...
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, Detect_NASF,
                   }:
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, (Segment)):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, Detect_NASF)):
                return "detect"
